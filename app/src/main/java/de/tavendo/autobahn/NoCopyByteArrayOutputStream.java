...
/**
 * OutputStream backed by a byte array. This class provides copyless access to
 * byte array backing the ByteArrayOutputStream
 */
public class NoCopyByteArrayOutputStream extends ByteArrayOutputStream {
	 ...
	 *
	 * @param size
	 *            Initial size of underlying byte array.
	 */
	...
	/**
	 * Get byte array underlying this OutputStream. This does not copy any data,
