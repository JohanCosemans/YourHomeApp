...
/**
 * OutputStream wrapping a ByteBuffer. This class internally allocates a direct
 * ByteBuffer for use i.e. with NIO for socket I/O. The ByteBuffer is
 * automatically enlarged if needed (preserving contents when enlarged).
 */
public class ByteBufferOutputStream extends OutputStream {
	 ...
	 *
	 * @param initialSize
	 *            Initial size of ByteBuffer.
	 * @param growSize
	 *            When buffer needs to grow, enlarge by this amount.
	 */
	 ...
	 *
	 * @param bytes
	 *            Write bytes from this byte array.
	 * @param off
	 *            Start reading at this offset within byte array.
	 * @param len
	 *            Write this many bytes, and enlarge underyling ByteBuffer when
	 *            necessary, preserving the contents.
	 */
	@Override
	...
	/**
	 * Write the UTF-8 encoding of a String to the underlying ByteBuffer via
	 * this OutputStream.
	 *
	 * @param str
