 ...
 * allocate ByteBuffers itself, but assumes the user has already one that just
 * needs to be wrapped to use with InputStream based processing.
 */
public class ByteBufferInputStream extends InputStream {
	 ...
	 *
	 * @param buffer
	 *            ByteBuffer to wrap as input stream.
	 */
	 ...
	 * @param off
	 *            Read bytes into byte array beginning at this offset.
	 * @param len
