...
public interface Wamp {
	...
	public static final String URI_WAMP_ERROR = Wamp.URI_WAMP_BASE + "error#";

	public static final String URI_WAMP_PROCEDURE = Wamp.URI_WAMP_BASE + "procedure#";

	public static final String URI_WAMP_TOPIC = Wamp.URI_WAMP_BASE + "topic#";

	public static final String URI_WAMP_ERROR_GENERIC = Wamp.URI_WAMP_ERROR + "generic";

	public static final String DESC_WAMP_ERROR_GENERIC = "generic error";

	public static final String URI_WAMP_ERROR_INTERNAL = Wamp.URI_WAMP_ERROR + "internal";
	...
	public interface ConnectionHandler {
		...
		/**
		 * Firex upon unsuccessful connection attempt or when connection was
	 ...
	 *            The handler for the session.
	 * @param headers
	 *            The headers with the connection
	 */
	 ...
	 *            The handler for the session.
	 * @param options
	 *            WebSockets and Autobahn option.s
	 * @param headers
	...
	public interface CallHandler {
		 ...
		 *
		 * @param result
		 *            The RPC result transformed into the type that was
		 *            specified in call.
		 */
		 ...
		 *
		 * @param errorUri
		 *            The URI or CURIE of the error that occurred.
		 * @param errorDesc
	 ...
	 *
	 * @param procUri
	 *            The URI or CURIE of the remote procedure to call.
	 * @param resultType
	 *            The type the call result gets transformed into.
	 * @param callHandler
	 *            The handler to be invoked upon call completion.
	 * @param arguments
	...
	public interface EventHandler {
		 ...
		 *
		 * @param topicUri
		 *            The URI or CURIE of the topic the event was published to.
		 * @param event
	...
	/**
	 * Subscribe to a topic. When already subscribed, overwrite the event
	 * handler.
	 *
	 * @param topicUri
